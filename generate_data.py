...
def get_config(cfile):
    ...
    # data
    parser.add_argument("--path", type=str, default=r"Desktop/CHANDU/ANN-SEM1/SS24_AssignmentFinal/SportBallsSmall", help="Dir to store data.")
    parser.add_argument("--test", action="store_true", help="Flag for test data")
    parser.add_argument("--train", action="store_true", help="Flag for train data") ###
